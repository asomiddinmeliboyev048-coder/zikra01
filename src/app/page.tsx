        ...
        <section className="overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-sm">
          ...
          <div className="px-4 pb-6 sm:px-8 sm:pb-8">
            ...
            <div className="-mt-10 sm:-mt-14">
              ...
              <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div className="flex min-w-0 flex-1 items-start gap-4 sm:gap-6">
                  ...
                  <div className="relative shrink-0">
                    ...
                    <div className="rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 p-[4px]">
              ...
              {/* =================================================
                  MY STORIES / INSTAGRAM HIGHLIGHTS
              ================================================= */}
              ...
              <section className="rounded-3xl border border-gray-100 bg-white p-5 shadow-sm sm:p-6">
                ...
                <div className="mb-5">
                  ...
                  <p className="mt-1 text-xs text-gray-400">
                    Foydalanuvchining bilim va o&apos;rganish yo&apos;nalishlari
                  </p>
